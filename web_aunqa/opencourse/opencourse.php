...
<head>
    ...
    <style>
        ...
        @media print {
            .sidebar, .main-header, .no-print, .btn, .alert, .modal, .form-check-input, .pagination-container, .search-container, .ts-wrapper { display: none !important; }
        ...
        <div class="row mb-3 no-print search-container">
            <div class="col-md-4 ms-auto">
                <div class="input-group">
                    ...
                    <input type="text" id="searchInput" class="form-control border-start-0 ps-0" placeholder="ค้นหารหัสวิชา, ชื่อวิชา, ผู้สอน...">
                </div>
            </div>
        </div>
...
<script>
    // --- ระบบตาราง ค้นหา และ แบ่งหน้า (เลียนแบบ course) ---
